...
<body>
<jsp:useBean id="objUser" type="firstjsp.pojo.User" scope="session"></jsp:useBean>
...
%>
<h1>Welcome <font color='red'><b> <jsp:getProperty property="userName" name="objUser"/><br/></b></font></h1><br/>
	<table border='1'>
		<tr>
			<th>Name</th>
			<th>Description</th>
